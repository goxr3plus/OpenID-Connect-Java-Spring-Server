...
var ClientModelView = Backbone.View.extend({
    ...
    initialize: function (options) {
        ...
        if (!this.template) {
            this.template = _.template($('#tmpl-services-twitter-table-tokens').html());
        }
...
var ServiceAccessTokenView = Backbone.View.extend({
    ...
    initialize: function (options) {
        ...
        if (!this.template) {
            this.template = _.template($('#tmpl-services-access-token').html());
        }
...
var ServiceRefreshTokenView = Backbone.View.extend({
    ...
    initialize: function (options) {
        ...
        if (!this.template) {
            this.template = _.template($('#tmpl-services-refresh-token').html());
        }
...
var ServiceListView = Backbone.View.extend({
    ...
    render: function (eventName) {
        ...
        $(this.el).html($('#tmpl-services-token-table').html());
...
ui.routes.push({
    ...
    callback: function () {
        ...
        view.load(function (collection, response, options) {
            ...
            setPageTitle($.t('services.manage'));
        });
        
        //alert("Called from Services JS");

    }
});

ui.templates.push('resources/template/services.html');
